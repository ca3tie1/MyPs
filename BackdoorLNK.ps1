...
<#
    ...
    .PARAMETER EXEPath
        The full path to execute after LNK target.
...
#>
    ...
    if($CleanUp) {
        ...
        $LaunchString = '[System.Diagnostics.Process]::Start("'+$TargetPath+'")'+$SleepTime+'[System.Diagnostics.Process]::Start("'+$EXEPath+'");'

        "[*]The LNK launchString:$LaunchString`n"
